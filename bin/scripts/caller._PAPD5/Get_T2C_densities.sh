...
#Get densities
~bilebi00/CDS_CLIP_ElMMo/scripts/generateGenomeAlignmets.pl $sampleId $chrid $strand T2C ALL > $outf;
#~bilebi00/CDS_CLIP_ElMMo/scripts/generateGenomeAlignmets.pl 67 $chrid $strand T2C ALL > $outf;
#~bilebi00/CDS_CLIP_ElMMo/scripts/generateGenomeAlignmets.pl 68 $chrid $strand T2C ALL >> $outf;
#~bilebi00/CDS_CLIP_ElMMo/scripts/generateGenomeAlignmets.pl 212 $chrid $strand T2C ALL >> $outf;
~bilebi00/CDS_CLIP_ElMMo/scripts/generateCumulativeScores.pl $outf > density-$outf
rm $outf;
